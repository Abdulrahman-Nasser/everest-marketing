                ...
                <div class="row">
                    <form action="{{route("home.store")}}" method="POST">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-center">Create New Home Image</h4>
                                    <div class="form-group">
                                        <label for="hue-demo">add Img :</label>
                                        <input type="file" name="fileUpload" class="form-control demo  @error('name') is-invalid @enderror"value="{{ old('name') }}">
                                    </div>
